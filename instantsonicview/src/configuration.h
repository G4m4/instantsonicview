...
/// @brief InstantSonicView configuration file
///
...
#ifndef INSTANTSONICVIEW_SRC_CONFIGURATION_H_
#define INSTANTSONICVIEW_SRC_CONFIGURATION_H_
...
#endif  // INSTANTSONICVIEW_SRC_CONFIGURATION_H_
