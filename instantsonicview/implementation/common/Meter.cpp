/*
 ...
 Various fixes in order to make it compile with modern JUCE by gm.
 This file is based on the JUCETICE library MeterComponent.
...
void MeterComponent::paint (Graphics& g)
{
    ...
    if(m_inset)
      juce::LookAndFeel_V3::drawBevel(g,
                                      0,
                                      0,
                                      getWidth(),
                                      getHeight(),
    ...
    else if(m_meterType == MeterAnalog)
    {
        ...
        if(m_needleLength)
        {
            ...
            g.drawArrow(juce::Line<float>(m_needleCenter.getX() + m_inset,
            ...
            if(m_needleDropShadow)
            {
                ...
                g.drawArrow(juce::Line<float>(m_needleCenter.getX() + m_inset + dropX,
        ...
        else
        {
            ...
            g.drawArrow(juce::Line<float>(w/2 + m_inset,
